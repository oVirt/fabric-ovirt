...
from fabric_ovirt.lib.foreman import foreman_defaults
...
try:
    ...
    frm_cli.requests.packages.urllib3.disable_warnings()
...
@serial
@foreman_defaults
def search(firstcond='', sure='no', foreman=None, user=None, passwd=None,
           *conds, **kwconds):
    """
